...
class User extends LsdActiveRecord
{
    ...
    public function canSeeInvitations()
    {
        return Role::hasAnyRole($this->id, [Role::kCM, Role::kOfficier, Role::kConseiller, Role::kSecretaire, Role::kTresorier, Role::kPresident, Role::kAdmin]);
    }
